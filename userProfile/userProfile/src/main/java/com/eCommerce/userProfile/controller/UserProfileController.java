...
public class UserProfileController {
 ...
 // inside com.eCommerce.userProfile.controller.UserProfileController (additions)
    ...
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    public org.springframework.data.domain.Page<com.eCommerce.userProfile.dto.AddressResponse> adminListAllAddrs(
    ...
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    public com.eCommerce.userProfile.dto.AddressResponse adminGetAddr(@PathVariable Long addressId) {
        return addressClient.adminGet(addressId);
    }

    @PostMapping("/admin/users/{userId}/addresses")
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    public com.eCommerce.userProfile.dto.AddressResponse adminCreateAddr(
            @PathVariable Long userId,
            @RequestBody @jakarta.validation.Valid com.eCommerce.userProfile.dto.AddressRequest req) {
    ...
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    public com.eCommerce.userProfile.dto.AddressResponse adminUpdateAddr(
            @PathVariable Long addressId,
            @RequestBody @jakarta.validation.Valid com.eCommerce.userProfile.dto.AddressRequest req) {
    ...
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    public com.eCommerce.userProfile.dto.AddressResponse adminSetDefaultAddr(@PathVariable Long addressId) {
